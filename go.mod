module github.com/danajp/sample-k8s-client
...
// copied from https://github.com/argoproj/argo-cd/blob/v2.7.13/go.mod
// per instructions here https://argo-cd.readthedocs.io/en/stable/user-guide/import/
replace (
